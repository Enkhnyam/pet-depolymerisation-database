...
FIGURES = ARTIFACTS / "figures_pdf"  # figure PDFs, \includegraphics-ed by the manuscript
# figures_pdf, not figures: the name is shared with the Overleaf project the manuscripts are
# submitted from, so one \includegraphics path resolves in both places.
